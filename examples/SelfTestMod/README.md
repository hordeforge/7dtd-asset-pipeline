...
| `assets-src/bundle/shamwaySelfTestCreature_albedo.png` | the creature's 256×256 albedo (`shamway generate hide` — a cream coat with dark spots), bound by the same `_albedo` convention — "textures on top" proven live, and a look run reads proportions at a glance |
