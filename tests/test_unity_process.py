...
class OpenFileLimitTests(unittest.TestCase):
    ...
    def test_a_low_limit_is_left_alone(self) -> None:
        ...
        low = (1024, 4096)
        with mock.patch.object(resource, "getrlimit", return_value=low) as get:
            with mock.patch.object(resource, "setrlimit") as put:
                _clamp_open_files()
        get.assert_called_once()
        put.assert_not_called()

    def test_a_high_limit_is_clamped_within_the_hard_limit(self) -> None:
        with mock.patch.object(resource, "getrlimit", return_value=(1048576, 1048576)):
            with mock.patch.object(resource, "setrlimit") as put:
                _clamp_open_files()
    ...
    def test_a_hard_limit_below_the_ceiling_is_respected(self) -> None:
        ...
        with mock.patch.object(resource, "getrlimit", return_value=(resource.RLIM_INFINITY, 4096)):
            with mock.patch.object(resource, "setrlimit") as put:
                _clamp_open_files()
