...
`texture2ddecoder` is installed (declared beside UnityPy in the inspect extra,
...
@unittest.skipUnless(
    ...
    "the cross-check needs texture2ddecoder, declared with UnityPy in the inspect extra",
)
