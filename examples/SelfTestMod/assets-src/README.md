...
| `shamwaySelfTestArachnid` | `shamway generate creature bundle/shamwaySelfTestArachnid.glb --rig arachnid --atlas creatures/shamwaySelfTestArachnid.atlas.json --hide bundle/shamwaySelfTestArachnid_albedo.png --coat charcoal --seed 7 --size 256` | arachnid rig, flat abdomen, legs splayed outboard, eight-leg tetrapod Walk, charcoal hide (tarsi painted as paws) | `bundle/shamwaySelfTestArachnid.glb` + `_albedo.png` + `.anim.json` | look run 2026-08-31 (`pass=1`); frame filed, not a human sign-off |
...
| `shamwaySelfTestHumanoid` | `shamway generate creature bundle/shamwaySelfTestHumanoid.glb --rig humanoid --atlas creatures/shamwaySelfTestHumanoid.atlas.json --hide bundle/shamwaySelfTestHumanoid_albedo.png --coat tan --seed 7 --size 256` | humanoid rig, X-arm boxes, biped Walk with opposite-arm swing, tan hide | `bundle/shamwaySelfTestHumanoid.glb` + `_albedo.png` + `.anim.json` | look run 2026-08-31 (`pass=1`); frame filed, not a human sign-off |
